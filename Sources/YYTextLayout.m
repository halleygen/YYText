...
- (instancetype)initWithContainer:(YYTextContainer *)container text:(NSAttributedString *)text range:(NSRange)range {
    ...
    layout.boundingRect = textBoundingRect;
    layout.boundingSize = textBoundingSize;
...
- (void)encodeWithCoder:(NSCoder *)aCoder {
    NSData *textData = [YYTextArchiver archivedDataWithRootObject:_text requiringSecureCoding:YES error:nil];
